...
import type { ScreenshotOptions, ScreenshotResult } from './universal-screenshot.js';
import { takeUniversalScreenshot } from './universal-screenshot.js';

/**
 * Playwright Page interface for screenshot operations
 */
