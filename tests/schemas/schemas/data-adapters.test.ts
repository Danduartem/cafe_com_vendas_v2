...
import type { LoadedPageSection, GlobalStrings } from '../../../src/_data/types.ts';

describe('Data Adapter Layer', () => {
  describe('Site Data Adapter', async () => {
    const { default: siteDataLoader } = await import('../../../src/_data/site.ts');
  ...
  describe('Global Data Adapter', async () => {
    const { default: globalDataLoader } = await import('../../../src/_data/global.ts');
  ...
  describe('Event Data Adapter', async () => {
    const { default: eventDataLoader } = await import('../../../src/_data/event.ts');
  ...
  describe('Presenter Data Adapter', async () => {
    const { default: presenterDataLoader } = await import('../../../src/_data/presenter.ts');
  ...
  describe('Data Transformation Consistency', () => {
    test('all data adapters should export default functions or objects', async () => {
      ...
      for (const adapter of adapters) {
        try {
          const module = await import(`../../../src/_data/${adapter}.ts`);
    ...
    test('data adapters should not throw during import', async () => {
      ...
      for (const adapter of adapters) {
        await expect(import(`../../../src/_data/${adapter}.ts`)).resolves.toBeDefined();
      }
    });
  });
