...
// netlify/functions/stripe-webhook.js
var stripe = stripe_esm_node_default(process.env.STRIPE_SECRET_KEY);
var MAILERLITE_API_KEY = process.env.MAILERLITE_API_KEY;
var MAILERLITE_GROUP_ID = process.env.MAILERLITE_GROUP_ID || "cafe-com-vendas";
  ...
  try {
    ...
    await addToMailerLite({
      ...
      fields: {
        ...
        event_name: metadata.event_name || "Caf\xE9 com Vendas",
  ...
  try {
    ...
    if (customerEmail) {
      await updateMailerLiteSubscriber(customerEmail, {
        ...
        payment_intent_id: paymentIntent.id,
        failure_date: (/* @__PURE__ */ new Date()).toISOString()
      });
  ...
  try {
    ...
    if (customerEmail) {
      await updateMailerLiteSubscriber(customerEmail, {
        ...
        payment_intent_id: paymentIntent.id,
        canceled_date: (/* @__PURE__ */ new Date()).toISOString()
      });
    }
  } catch (error) {
